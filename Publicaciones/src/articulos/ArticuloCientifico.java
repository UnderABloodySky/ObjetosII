...
public class ArticuloCientifico implements Articulo{
	...
	List<String> palabrasClaves;
		...
		ArticuloCientifico(String _nombre, String autor, String _filiacion, String _tipo, String _lugar, List<String> _palabras){
			nombre = _nombre;
		...
		ArticuloCientifico(String _nombre, List<String> _autores, String _filiacion, String _tipo, String _lugar, List<String> _palabras){
			nombre = _nombre;
			autores = _autores;
			filiacion = _filiacion;
			tipoDeArticulo = _tipo;
